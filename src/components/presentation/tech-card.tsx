    ...
    <div className="text-white">
      ...
      <div className="flex flex-col items-center lg:flex-row justify-around flex-wrap space-y-8 lg:space-y-0 lg:space-x-10 px-4 lg:px-20">
        <CardSpotlight className="w-[80vw] h-[50vw] sm:w-[60vw] sm:h-[40vw] lg:w-[20vw] lg:h-[20vw] rounded-3xl text-center">
          ...
          <div className="text-sm lg:text-base tracking-widest">
            ...
            de développer des interfaces utilisateur robustes et typées pour des
      ...
      <div className="flex flex-col items-center lg:flex-row justify-around flex-wrap space-y-8 lg:space-y-0 lg:space-x-10 px-4 lg:px-20">
        ...
        <CardSpotlight className="w-[80vw] h-[50vw] sm:w-[60vw] sm:h-[40vw] lg:w-[20vw] lg:h-[20vw] rounded-3xl text-center">
          ...
          <br />
          <div className="text-sm lg:text-base tracking-widest">
            Je maîtrise le langage Java ainsi que le framework Spring, ce qui me
            permet de concevoir et développer des applications backend robustes,
      ...
      <div className="flex flex-col items-center lg:flex-row justify-around flex-wrap space-y-8 lg:space-y-0 lg:space-x-10 px-4 lg:px-20">
        ...
        <CardSpotlight className="w-[80vw] h-[50vw] sm:w-[60vw] sm:h-[40vw] lg:w-[20vw] lg:h-[20vw] rounded-3xl text-center">
          ...
          <div className="text-sm lg:text-base tracking-widest">
            ...
            permettant de concevoir et d’optimiser efficacement des systèmes de
            gestion de données fiables et performants.
          </div>
        </CardSpotlight>
      </div>
    </div>
